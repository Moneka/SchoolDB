...
?>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Hey buddy!</h1>
        <p>Hope you are having fun in the school!! :)</p>
...
<div id = "tasks" class="container-fluid text-center">
  ...
  <div class="row">
    ...
    <div class="col-sm-4 text-center">
      <h4><a href="stucourses.php"> My Courses </a></h4>
    </div>
      
<!--
     <div class="col-sm-4">
      <h4><a href="duedate.php"> My deadlines </a></h4>
    </div>
        
       <div class="col-sm-4">
      <h4><a href="clubs.php"> My Clubs </a></h4>
    </div>
  
    <div class="col-sm-4">
      <h4><a href="myfee.php"> Tuitions </a></h4>
    </div>
-->
