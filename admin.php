...
?>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Hey Admin!</h1>
        <p>Good Luck with all your work!! ;)</p>
      </div>
    </div>
...
if(isset($_POST['edit'])){
 ...
 <div id = "tasks" class="container-fluid text-center">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <h4><a href="registermember.php"> Register a Member </a></h4>
    </div>
        
       <div class="col-sm-4">
      <h4><a href="managecourses.php"> Courses </a></h4>
    </div>
        
<!--
       <div class="col-sm-4">
      <h4><a href="manageclubs.php"> Clubs </a></h4>
    </div>
-->
        
       <div class="col-sm-4">
      <h4><a href="managesalaries.php"> Salaries </a></h4>
    </div>
        
       <div class="col-sm-4">
      <h4><a href="managetuitions.php"> Tuitions </a></h4>
    </div>
      
<!--
    <div class="col-sm-4">
      <h4><a href="queries.php"> Queries </a></h4>
    </div>
-->
